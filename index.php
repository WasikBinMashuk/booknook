...
<body>
    <section id="main-header">
        <a href="index.php"><img src="img/bn.png" class="logo"></a>
        <div>
            <ul id="navbar">
...
?>
<li><a href="#" style="text-decoration: none;" class="fas fa-user" data-bs-toggle="modal" data-bs-target="#exampleModalToggle"></a></li>
            </ul>
        </div>
    </section>
    ...
    <section id="hero">
        <div class="content">
            ...
            <h3>New at our store?</h3>
            <button class="btn-1" onclick="location.href='register.php'">Register</button>
            <p>Already registered? <a href="/registration/buyer/buyer_registration.html">Log In</a></p>
        </div>
       
    </section>
    <section id="service" class="section-p1">
        <h2>Why buy books from BookNook?</h2>
        <div>
            <div class="icon-box">
                    ...
                    ?>                     
                                  <div class="product">
                                    ...
                                    <div class="pro-title">
                                        ...
                                        <button style="width:100%;"  name="#" type="submit">Rent</button>
                                        <a href="#"><img src="img/cart.png" alt=""></a>
                                        <form action="shop.php" method="POST"> 
                                        <button  style="margin-top:10px;"  name="add" type="submit" class="ADDTOCART">ADD TO CART</button>
            ...
            <form action="login.php" method="POST" class="login">
              ...
              <a class="forgot" style="text-decoration: none; margin-left:20%;"  data-bs-target="#exampleModal4" data-bs-toggle="modal" href="#">Forgot Password?</a>
                      ...
                      <div class="modal-footer">
                        <button style="margin-right:34%;background-color:rgb(163, 33, 85);  border:1px solid rgb(163, 33, 85);" class="btn btn-primary"  data-bs-target="#exampleModal3" data-bs-toggle="modal" onclick="location.href='register.php'">Create Account</button>
                        <<!-- button class="btn-1" onclick="location.href='register.php'">Register</button> -->
                      </div>
                    </div>
                  </div>
